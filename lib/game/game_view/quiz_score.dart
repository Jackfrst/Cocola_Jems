...
import 'package:cocola_jems/page/main_score.dart';
...
class QScore extends StatefulWidget {
  const QScore({Key? key}) : super(key: key);

  @override
  State<QScore> createState() => _QScoreState();
}

class _QScoreState extends State<QScore> {
                          ...
                          MyTextIconButton(
                            ...
                            onPressed: () {
                              ...
                              Navigator.of(context).push(
                                  MaterialPageRoute(builder: (_) => Game2()));
                            },
                            icon: const Icon(
